      ...
      <div className="min-h-[300px]">
          ...
          {activeTab === 'exams' && (
               <div className="space-y-4">
                   {classDetail.exams && classDetail.exams.length > 0 ? (
                       classDetail.exams.map(exam => (
                           <div key={exam.id} className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 hover:border-emerald-500/30 transition-all group">
                               <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                                   <div>
                                       ...
                                       <div className="flex flex-wrap gap-4 mt-2 text-sm text-slate-400">
                                           ...
                                           <div className="flex items-center gap-1.5">
                                               ...
                                               {formatLocalDateTime(exam.startTime)} - {formatLocalDateTime(exam.endTime)}
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <button
                                      ...
                                      className="px-6 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-medium shadow-lg shadow-emerald-500/20 transition-all transform hover:-translate-y-0.5"
                                   >
                                      Vào thi
                                   </button>
                               </div>
