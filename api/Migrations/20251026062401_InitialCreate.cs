    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentClasses", x => new { x.EnrolledClassesId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentClasses_Classes_EnrolledClassesId",
                        column: x => x.EnrolledClassesId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentClasses_Users_StudentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObjectiveScore = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SubjectiveScore = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
